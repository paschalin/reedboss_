...
return [
    ...
    'custom' => [
        'g-recaptcha-response' => [
            ...
            'captcha'  => 'CAPTCHA Fehler! Versuchen Sie es später noch einmal oder wenden Sie sich an den Site-Administrator.',
        ],
    ],
    'local_captcha' => 'CAPTCHA Fehler! Bitte versuche es erneut.',
];
