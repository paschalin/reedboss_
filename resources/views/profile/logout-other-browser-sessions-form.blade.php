<x-jet-action-section>
  ...
  <x-slot name="content">
            ...
            <div>
              ...
              @else
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                  stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-500">
    ...
    <x-jet-dialog-modal maxWidth="md" wire:model="confirmingLogout">
      <x-slot name="title">
        {{ __('Log Out Other Browser Sessions') }}
      </x-slot>
      ...
      <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}"
          ...
          <x-jet-input type="password" class="mt-1 block w-full" placeholder="{{ __('Password') }}" x-ref="password"
