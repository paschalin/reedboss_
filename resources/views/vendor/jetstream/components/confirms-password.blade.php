...
@once
  <x-jet-dialog-modal maxWidth="md" wire:model="confirmingPassword">
    <x-slot name="title">
      {{ $title }}
    </x-slot>
    ...
    <x-slot name="content">
      ...
      <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
        <x-jet-input type="password" class="mt-1 block w-full" placeholder="{{ __('Password') }}" x-ref="confirmable_password"
