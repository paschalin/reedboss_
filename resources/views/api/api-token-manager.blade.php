<div>
  ...
  <x-jet-form-section submit="createApiToken">
    ...
    <x-slot name="actions">
      <x-jet-action-message class="ltr:mr-3 rtl:ml-3" on="created">
        {{ __('Created.') }}
  ...
  <x-jet-dialog-modal wire:model="displayingToken">
    ...
    <x-slot name="content">
      ...
      <x-jet-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
        class="mt-4 bg-gray-100 px-4 py-2 rounded font-mono text-sm text-gray-500 w-full break-all" autofocus autocomplete="off"
