<x-guest-layout>
  ...
  <x-jet-authentication-card class="-mb-32">
    <div class="text-center">
      <p class="text-base font-semibold text-primary-600">500</p>
      <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl">{{ __('Server error') }}</h1>
      <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-400">
        {{ __('Sorry, server encountered an error, please try again later.') }}
      </p>
      @if (auth()->user() &&
